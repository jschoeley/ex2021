...
dat$lt_input_100_f <- filter(dat$lt_input_100, sex == 'Female')
dat$lt_input_100_m <- filter(dat$lt_input_100, sex == 'Male')
dat$lt_input_100_t <- dat$lt_input_100_f
dat$lt_input_100_t$sex <- 'Total'
dat$lt_input_100_t$death_total <-
  dat$lt_input_100_f$death_total + dat$lt_input_100_m$death_total
dat$lt_input_100_t$population_py <-
  dat$lt_input_100_f$population_py + dat$lt_input_100_m$population_py
dat$lt_input_100_t$population_midyear <-
  dat$lt_input_100_f$population_midyear + dat$lt_input_100_m$population_midyear
dat$lt_input_100_t$death_covid <-
  dat$lt_input_100_f$death_covid + dat$lt_input_100_m$death_covid
dat$lt_input_100_t$ex_wpp_estimate <- NA
dat$lt_input_100_t$ex_hmd_estimate <- NA
substr(dat$lt_input_100_t$id, 7, 7) <- 'T'
...
dat$lt_ex_diff_mean <-
  dat$lt_85 %>%
  filter(year %in% c(2015:config$skeleton$year$max)) %>%
...
saveRDS(dat$lt_ex_diff_long, file = glue('{wd}/out/lt_ex_diff_long.rds'))
