...
%(Ridhi) Some references that are relevant for contextualising the sex gap in life expectancy -- noting that sex gaps were closing pre-pandemic due to slowdowns in female mortality improvements due to increases in smoking-linked mortality.
%General trends of the sex gap: https://www.pnas.org/content/pnas/118/20/e2010588118.full.pdf
%https://www.tandfonline.com/doi/full/10.1080/00324720701331433
%contribution of smoking: https://link.springer.com/article/10.1007/s10654-020-00602-x
%smoking matters, but less in Eastern Europe, is more heterogenous: https://academic.oup.com/eurpub/article/25/4/706/2399079?login=true
...
\begin{figure}[ht!]
    \centering
    \Oldincludegraphics[angle=90,height=0.92\textheight]{e0diffhistoric.pdf}
...
%\footnote{We used the age harmonized data on COVID-19 death counts from COVerAGE-DB\citealp{Riffe2021} which, for France, sourced the data from Santé Publique France via the ``La démographie des décès par COVID-19'' database published by the Institut national d’études démographiques.\citealp{INED2022}}
...
% - consequences for future life expectancy and mortality trends
% - potential for systemic and lasting damage to health care systems via staff burnout and subsequent resignation, reducing the capacity of the health care system
% - reversal of global life expectancy convergence via polarisation of countries into those which reversed life expectancy losses and those which compounded life expectancy losses
% - Eastern disadvantage
%    - Lower healthcare capacity due to long-running out-migration
%    - much greater vaccination hesitancy
% - Nordic advantage
%    - hard to explain with vaccinations alone
%    - same reasons as past-nordic advantage?
